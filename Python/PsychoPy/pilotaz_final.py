...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\pcisl\\Desktop\\statystyka\\procedura mac-20190515T080150Z-001\\procedura mac\\pilotaz2_2.py',
...
instrukcja_img = visual.ImageStim(
    win=win,
    name='instrukcja_img', 
    image='instrukcje/imagined_priming.jpg', mask=None,
...
instrukcja_2_img = visual.ImageStim(
    ...
    image='instrukcje/visual_priming.jpg', mask=None,
...
#    things=['tr1','tr2','tr3','tr4','tr5','tr6','tr7']
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED:
            theseKeys = event.getKeys(keyList=['lalt', 'ralt'])
